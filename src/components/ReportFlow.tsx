    ...
    <div className="fixed inset-0 z-[2000] flex items-end justify-center bg-black/50 animate-fade-in" onClick={onClose}>
      ...
      >
        ...
        {step === 3 && (
          <div className="p-5 space-y-4">
            <div>
              <h3 className="text-sm font-semibold text-gray-800">Detalles y ubicación</h3>
              <p className="text-xs text-gray-500 mt-0.5">Describe brevemente lo que ocurre.</p>
            </div>
              ...
              <textarea
                ...
                placeholder={
                  tipo === 'corte_calle'
                    ...
                    : 'ej. Bache de gran tamaño cerca del cruce, daña neumáticos.'
                }
                rows={2}
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between rounded-xl bg-gray-50 px-3.5 py-2.5">
                ...
                <button
                  ...
                  disabled={isLocating}
                  className="rounded-lg bg-blue-600 px-2.5 py-1 text-xs font-medium text-white hover:bg-blue-700 disabled:bg-blue-400"
                >
                  {isLocating ? 'Obteniendo...' : 'Actualizar GPS'}
                </button>
              </div>
              {locationMessage && (
                <p className="text-[11px] text-gray-500">{locationMessage}</p>
              )}
            </div>
          </div>
        )}
